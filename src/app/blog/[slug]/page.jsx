                    ...
                    <div className="col-lg-8 col-md-12">
                        <div className="blog-details-desc">
                            <div className="article-image">
                                <Image src={blog.imageDetails} alt={blog.title} width={810} height={590} />
                            </div>
                            <div className="article-content">
                                ...
                                <p>
                                    ...
                                    in reprehenderit in sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.
                                </p>
                                ...
                                <ul className="wp-block-gallery columns-3">
                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <Image width={750} height={500} src="/images/blog/img15.jpg" alt="image" />
                                        </figure>
                                    </li>
                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <Image width={750} height={500} src="/images/blog/img14.jpg" alt="image" />
                                        </figure>
                                    </li>
                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <Image width={750} height={500} src="/images/blog/img13.jpg" alt="image" />
                                        </figure>
                                    </li>
                                </ul>
                                ...
                                <ul className="features-list">
                                    <li>
                                        <FontAwesomeIcon icon={faCheckCircle} /> Scientific skills for getting a better result
                                    </li>
                                    <li>
                                    <FontAwesomeIcon icon={faCheckCircle} /> Communication skills to getting in touch
                                    </li>
                                    <li>
                                    <FontAwesomeIcon icon={faCheckCircle} /> A career overview opportunity available
                                    </li>
                                    <li>
                                    <FontAwesomeIcon icon={faCheckCircle} /> A good work environment for work
                                    </li>
                                </ul>
                            ...
                            <div className="article-author">
                                ...
                                <div className="author-profile">
                                    <div className="author-profile-title">
                                        <Image width={300} height={300} src="/images/user/user1.jpg" className="shadow-sm" alt="image" />
                            ...
                            <div className="elearniv-post-navigation">
                                <div className="prev-link-wrapper">
                                    <div className="info-prev-link-wrapper">
                                        <Link href="/">
                                            <span className="image-prev">
                                                <Image width={750} height={500} src="/images/blog/img11.jpg" alt="image" />
                                            ...
                                            <span className="prev-link-info-wrapper">
                                                ...
                                                <span className="meta-wrapper">
                                                    <span className="date-post">January 21, 2025</span>
                                                </span>
                                            </span>
                                        </Link>
                                    </div>
                        ...
                        <span className="next-title">
                            28 Student-Centered Instructional Strategies
                                            ...
                                            <span className="meta-wrapper">
                            <span className="date-post">January 19, 2025</span>
                                            </span>
                                            </span>
                                            <span className="image-next">
                        <img src="/images/blog/img12.jpg" alt="image" />
